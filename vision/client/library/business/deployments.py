...
from vision.client.library.blockchains import BlockchainClient
from vision.client.library.blockchains import get_blockchain_client
from vision.client.library.business.base import Interactor
from vision.client.library.business.base import InteractorError
from vision.client.library.configuration import config
from vision.client.library.configuration import get_blockchain_config
...
class TokenDeploymentInteractor(Interactor):
    """Interactor for handling Vision compatible token deployments.
    ...
    class __DeploymentFee:
        """Deployment fee data for deploying Vision compatible
    ...
    def deploy_token(self, request: TokenDeploymentRequest) -> uuid.UUID:
        """Deploy a Vision compatible token.
        ...
        -------
        uuid.UUID
            The Vision token creator's task ID.
        ...
        vsn_token_address = blockchain_config['tokens']['vsn']
    ...
    def __submit_deployment_request(
        ...
        """Submit a deployment request to the Vision token creator service.
    ...
    def __get_payment_response(
            ...
            deployment_blockchains: typing.List[Blockchain]) \
            -> __PaymentResponse:
        """Get the payment response from the Vision token
        creator service.
    ...
    def __get_cheapest_bid_response(
        ...
        """Get the cheapest bid response from the Vision token
        creator service.
