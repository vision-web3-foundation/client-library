"""Business logic for handling Vision token transfers.
...
from vision.common.entities import BlockchainAddressBidPair
...
from vision.common.types import TokenId
...
class TransferInteractor(Interactor):
    """Interactor for handling Vision token transfers.
