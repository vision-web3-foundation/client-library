"""Module that implements the Vision client library's API which is
exposed to the users of the library.

"""
__all__ = [
    'Blockchain', 'BlockchainAddress', 'VisionClientError', 'PrivateKey',
    ...
    'get_token_transfer_status', 'deploy_vision_compatible_token'
]

import uuid as _uuid

from vision.common.blockchains.base import Blockchain
from vision.common.entities import \
    BlockchainAddressBidPair as _BlockchainAddressBidPair
from vision.common.entities import ServiceNodeBid
from vision.common.types import AccountId as _AccountId
from vision.common.types import Amount as _Amount
from vision.common.types import BlockchainAddress
from vision.common.types import PrivateKey
from vision.common.types import TokenId as _TokenId
from vision.common.types import TokenSymbol

from vision.client.library import initialize_library as _initialize_library
from vision.client.library.blockchains import \
    get_blockchain_client as _get_blockchain_client
from vision.client.library.business.bids import BidInteractor as _BidInteractor
from vision.client.library.business.deployments import \
    TokenDeploymentInteractor as _TokenDeploymentInteractor
from vision.client.library.business.tokens import \
    TokenInteractor as _TokenInteractor
from vision.client.library.business.transfers import \
    TransferInteractor as _TransferInteractor
from vision.client.library.constants import \
    TOKEN_SYMBOL_VSN as _TOKEN_SYMBOL_VSN
from vision.client.library.entitites import DestinationTransferStatus
from vision.client.library.entitites import ServiceNodeTaskInfo
from vision.client.library.entitites import TokenTransferStatus
from vision.client.library.exceptions import ClientError as _ClientError

# Exception to be used by external client library users
VisionClientError = _ClientError
...
def retrieve_service_node_bids(
    ...
    return_fee_in_main_unit : bool, optional
        ...
        Vision Token's main unit, False if it is to be returned in the
        Vision Token's smallest subunit (default: True).
...
def retrieve_token_balance(blockchain: Blockchain, account_id: _AccountId,
                           token_id: _TokenId = _TOKEN_SYMBOL_VSN,
    ...
    token_id : BlockchainAddress or TokenSymbol
        The address or symbol of the token (default: VSN).
...
def deploy_vision_compatible_token(token_name: str, token_symbol: str,
    ...
    """Deploy a Vision-compatible token on the given blockchains.
