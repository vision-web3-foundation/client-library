...
class EthereumClient(BlockchainClient):
    ...
    def _create_hub_contract(
        ...
        try:
            return self._get_utilities().create_contract(
                ...
                VersionedContractAbi(ContractAbi.VISION_HUB,
    ...
    def _create_token_contract(
        ...
        try:
            return self._get_utilities().create_contract(
                token_address,
                VersionedContractAbi(ContractAbi.VISION_TOKEN,
                                     self.protocol_version), node_connections)
        except Exception:
            raise self._create_error(
    ...
    def __get_transfer_message_data(
        ...
        return {
            ...
            'visionHub': self._get_config()['hub'],
            'visionForwarder': self._get_config()['forwarder'],
            'visionToken': self._get_config()['tokens'][TOKEN_SYMBOL_VSN]
        }
